...
7. Find the __LED.csproj__ file - select it and click __Open__

This will add the _LED_ project to you new _Samples_ directory.

In the _LED_ project you need to update the reference to _GrovePi_.

1. In _Solution Explorer_ expand the _LED_ project and the _References_ node.
...
1. Open __GrovePi\Software\CSharp\Samples\LED.sln__ in Visual Studio.   
2. In _Solution Explorer_ expand the _LED_ project and the _References_ node.  
...
1. Right-click on the _LED_ project in the _Solution Explorer_
2. Select __Set as Startup Project__
3. Right-click on the __Properties__ node under _LED_ and select __Open__
